...
public final class WeaponFactoryTest {
	...
	public void test_assorted_getTriggers() {
		...
		assertEquals(Collections.singletonList(new Brave()), WeaponFactory.getWeapon("Brave Bow").getTriggers());
		...
		assertEquals(Collections.singletonList(new CrossBow()), WeaponFactory.getWeapon("Bowgun").getTriggers());
		assertEquals(Collections.singletonList(new CrossBow()), WeaponFactory.getWeapon("Crossbow").getTriggers());
		assertEquals(Collections.singletonList(new CrossBow()), WeaponFactory.getWeapon("Aqqar").getTriggers());
		assertEquals(Collections.singletonList(new CrossBow()), WeaponFactory.getWeapon("Arbalest").getTriggers());
	}
}