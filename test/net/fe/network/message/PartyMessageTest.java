...
public final class PartyMessageTest {
	...
	public void test_validateTeam_acceptsEmptyParty() {
		Optional<String> result = new PartyMessage(new ArrayList<>()).validateTeam(UnitFactory.getAllUnits().stream(), Item.getAllItems().stream(), new ArrayList<>());
	...
	public void test_validateTeam_acceptsSingleLord() {
		...
		Optional<String> result = new PartyMessage(units).validateTeam(UnitFactory.getAllUnits().stream(), Item.getAllItems().stream(), new ArrayList<>());
		assertFalse(result.isPresent());
	}
	...
	public void test_validateTeam_AcceptsVeterans() {
		...
		Optional<String> result = new PartyMessage(units).validateTeam(UnitFactory.getAllUnits().stream(), Item.getAllItems().stream(), mods);
		assertFalse(result.isPresent());
	}
	...
	public void test_validateTeam_RejectsTooMuchSpent() {
		...
		Optional<String> result = new PartyMessage(units).validateTeam(UnitFactory.getAllUnits().stream(), java.util.Collections.singleton(liquidGold).stream(), new ArrayList<>());
		assertTrue(result.isPresent());
	}
	...
	public void test_validateTeam_AcceptsTreasury() {
		...
		Optional<String> result = new PartyMessage(units).validateTeam(UnitFactory.getAllUnits().stream(), java.util.Collections.singleton(liquidGold).stream(), mods);
		assertFalse(result.isPresent());
	}
